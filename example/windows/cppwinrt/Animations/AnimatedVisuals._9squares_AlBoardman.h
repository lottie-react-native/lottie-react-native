...
// </auto-generated>
//------------------------------------------------------------------------------
#include "AnimatedVisuals._9squares_AlBoardman.g.h"
...
namespace winrt::AnimatedVisuals
{
    ...
    {
        class _9squares_AlBoardman
            : public _9squares_AlBoardmanT<_9squares_AlBoardman>
        {
        public:
            // Animation duration: 5.867 seconds.
    ...
    {
        struct _9squares_AlBoardman : _9squares_AlBoardmanT<_9squares_AlBoardman, implementation::_9squares_AlBoardman>
        {
        };
    }
}
