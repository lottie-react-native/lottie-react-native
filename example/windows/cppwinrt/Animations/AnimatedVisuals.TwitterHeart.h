...
// </auto-generated>
//------------------------------------------------------------------------------
#include "AnimatedVisuals.TwitterHeart.g.h"
...
namespace winrt::AnimatedVisuals
{
    ...
    {
        class TwitterHeart
            : public TwitterHeartT<TwitterHeart>
        {
        public:
            // Animation duration: 1.933 seconds.
    ...
    {
        struct TwitterHeart : TwitterHeartT<TwitterHeart, implementation::TwitterHeart>
        {
        };
    }
}
