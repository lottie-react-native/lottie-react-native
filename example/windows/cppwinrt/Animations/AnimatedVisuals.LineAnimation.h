...
// </auto-generated>
//------------------------------------------------------------------------------
#include "AnimatedVisuals.LineAnimation.g.h"
...
namespace winrt::AnimatedVisuals
{
    ...
    {
        class LineAnimation
            : public LineAnimationT<LineAnimation>
        {
        public:
    ...
    {
        struct LineAnimation : LineAnimationT<LineAnimation, implementation::LineAnimation>
        {
        };
    }
}
