...
// </auto-generated>
//------------------------------------------------------------------------------
#include "AnimatedVisuals.HamburgerArrow.g.h"
...
namespace winrt::AnimatedVisuals
{
    ...
    {
        class HamburgerArrow
            : public HamburgerArrowT<HamburgerArrow>
        {
        public:
    ...
    {
        struct HamburgerArrow : HamburgerArrowT<HamburgerArrow, implementation::HamburgerArrow>
        {
        };
    }
}
